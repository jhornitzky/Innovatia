...
1.] Specify URL for each device type
*/
//mobile_device_detect('iPhone_URL','iPad_URL','Android_URL','Opera_URL','BlackBerry_URL','PalmOS_URL','WinMobile_URL','MobileBrowser_URL','DesktopBrowser_URL');

/*
2.] Specify return value given a particular device 
Hence first arg is iPhone, if you place true as the parameter, if iPhone is detected then true is returned
*/
//mobile_device_detect(true,true,true,false,true,false,true,URLOnly,URLOnly);
