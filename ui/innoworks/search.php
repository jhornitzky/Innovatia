...
function hasSearchTerms() {
	global $searchTerms;
	if (!isset($_GET['searchTerms']) || empty($searchTerms) || $searchTerms == "undefined")
		return false;
	return true;
}
...
$ideas = getSearchIdeas($searchTerms, $userId, $filters);
$users = getSearchPeople($searchTerms, $userId, $filters);
$groups = getSearchGroups($searchTerms, $userId, $filters);
