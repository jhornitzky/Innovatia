...
<table style="vertical-align: middle; margin-top: 0.7em">
	<tr>
		<td>
			<img id="logo" style="width: 90px; height: 55px;" src="<?= $serverRoot?>ui/style/kubu.png" /></td>
		<td>
			<span style="font-size: 2.0em; font-weight: bold; padding-left: 0.1em;">Innoworks</span>
		</td>
	</tr>
</table>
</div>
