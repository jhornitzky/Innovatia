							...
							dijit._DialogMixin ],
					{
										...
										beforeBegin : dojo
												.hitch(
														...
														function() {
															...
															if (!_3) {
																_3 = dijit._underlay = new dijit.DialogUnderlay(
																		this.underlayAttrs);
															} else {
																_3
																		.attr(this.underlayAttrs);
															}
															...
															if (ds.length == 0) {
																...
																dojo
																		.style(
																				...
																				948 + ds.length * 2);
																dijit._underlay
																		.attr(ds[ds.length - 1].underlayAttrs);
															}
															if (this.refocus) {
						...
						_onKey : function(_a) {
							...
							if (_a.charOrCode) {
								...
								if (_b == this._firstFocusItem && _a.shiftKey
										&& _a.charOrCode === dk.TAB) {
									if (!_c) {
										dijit.focus(this._lastFocusItem);
									}
									dojo.stopEvent(_a);
								} else {
									if (_b == this._lastFocusItem
											&& _a.charOrCode === dk.TAB
											&& !_a.shiftKey) {
										if (!_c) {
											...
											.connect(
													...
													function() {
														...
														if (!this._oldViewport
																|| _d.h != this._oldViewport.h
																|| _d.w != this._oldViewport.w) {
															this.layout();
