					...
					[ dojox.layout.ContentPane, dijit._Templated ],
					{
						...
						postCreate : function() {
							...
							if (!this.resizable) {
								...
								this.domNode.style.width = dojo
										.marginBox(this.domNode).w
										+ "px";
							}
						...
						startup : function() {
							...
							this.connect(this.focusNode, "onmousedown",
									"bringToTop");
						...
						setTitle : function(_4) {
							dojo.deprecated("pane.setTitle",
									"Use pane.attr('title', someTitle)", "2.0");
							this.attr("title", _4);
						},
						close : function() {
							if (!this.closable) {
						...
						maximize : function() {
							...
							if (this._isDocked) {
								this.show();
								setTimeout(dojo.hitch(this, "maximize"),
										this.duration);
							}
							dojo.addClass(this.focusNode,
						...
						resize : function(_8) {
							...
							var _a = {
								...
								t : 0,
								w : _8.w,
								h : (_8.h - this.focusNode.offsetHeight)
							};
						...
						bringToTop : function() {
							...
							dojo.forEach(_b,
									function(w, x) {
										w.domNode.style.zIndex = this._startZ
												+ (x * 2);
						...
						destroy : function() {
							this._allFPs.splice(dojo
									.indexOf(this._allFPs, this), 1);
	...
	dojo
			.declare(
					...
					[ dijit._Widget, dijit._Templated ],
					{
						...
						addNode : function(_c) {
							var _d = dojo
									.create("li", null, this.containerNode), _e = new dojox.layout._DockNode(
									{
										title : _c.title,
										paneRef : _c
									}, _d);
						...
						startup : function() {
							if (this.id == "dojoxGlobalFloatingDock"
									|| this.isFixedDock) {
								this.connect(window, "onresize",
										"_positionDock");
								this.connect(window, "onscroll",
										"_positionDock");
								if (dojo.isIE) {
